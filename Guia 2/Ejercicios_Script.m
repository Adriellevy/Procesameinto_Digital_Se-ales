...
% FuncionRespuestaZHomeMade = polyval(y, Z); % Evaluar la funcion en Z
% 
...
% title('Modulo de la Transformada Z');
% xlabel('Re(Z)');
% ylabel('|X(z)|');
% grid on;
% 
...
% title('Modulo de la Transformada Fourrier');
% xlabel('t');
% ylabel('|X(w)|');
% grid on;
% subplot(2, 4, 7);
...
% title('Modulo de la Transformada Z a mano');
% xlabel('Re(Z)');
% ylabel('|X(z)|');
% grid on;
% axis([0 80 0 60]);
